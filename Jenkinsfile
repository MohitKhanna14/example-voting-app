    ...
    stage("Build vote app"){
      ...
      steps{
       script {
                    ...
                    sh "$SSH 'cd /home/ubuntu/workspace/voteapp; sed -i 's+build: ./vote+image: mohit1412/voteapp:latest+g' docker-compose.yml; docker-compose -f docker-compose.yml up -d;'"
              }
           }
         }
  }
